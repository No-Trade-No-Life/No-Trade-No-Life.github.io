const r=`.flexlayout__layout {\r
  ...
  --color-5: #404040;\r
  --color-6: #4d4d4d;\r
  --color-drag1: rgb(207, 232, 255);\r
  --color-drag2: rgb(183, 209, 181);\r
  --color-drag1-background: rgba(128, 128, 128, 0.15);\r
  --color-drag2-background: rgba(128, 128, 128, 0.15);\r
  --font-size: medium;\r
  --font-family: Roboto, Arial, sans-serif;\r
  --color-overflow: gray;\r
  --color-icon: gray;\r
  --color-tabset-background: var(--color-1);\r
  ...
  --color-tabset-header-background: var(--color-1);\r
  --color-tabset-header: var(--color-text);\r
  --color-border-background: var(--color-1);\r
  ...
  --color-splitter: var(--color-2);\r
  --color-splitter-hover: var(--color-4);\r
  --color-splitter-drag: var(--color-5);\r
  --color-drag-rect-border: var(--color-4);\r
  --color-drag-rect-background: var(--color-1);\r
  --color-drag-rect: var(--color-text);\r
  --color-popup-border: var(--color-6);\r
  --color-popup-unselected: var(--color-text);\r
  --color-popup-unselected-background: black;\r
  --color-popup-selected: var(--color-text);\r
  --color-popup-selected-background: var(--color-4);\r
...
.flexlayout__tabset_header {\r
  ...
  box-shadow: inset 0 0 3px 0 rgba(136, 136, 136, 0.54);\r
}\r
...
.flexlayout__tabset-selected {\r
  ...
  background-image: linear-gradient(var(--color-background), var(--color-4));\r
}\r
.flexlayout__tabset-maximized {\r
  background-color: var(--color-tabset-background-maximized);\r
  background-image: linear-gradient(var(--color-6), var(--color-2));\r
}\r
...
.flexlayout__tab_button_top {\r
  box-shadow: inset -2px 0px 5px rgba(0, 0, 0, 0.1);\r
  border-top-left-radius: 3px;\r
  border-top-right-radius: 3px;\r
}\r
.flexlayout__tab_button_bottom {\r
  box-shadow: inset -2px 0px 5px rgba(0, 0, 0, 0.1);\r
...
\r
/*# sourceMappingURL=dark.css.map */\r
`;export{r as default};
